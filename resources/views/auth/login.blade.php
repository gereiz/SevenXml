...
@section('content')
<body
    class="flex items-center justify-center min-h-screen px-4 py-16 bg-cover bg-[#0024B3] dark:bg-auth-pattern-dark dark:text-zink-100 font-public">
    <div class="mb-0 border-none shadow-none xl:w-2/3 card bg-white/70 dark:bg-zink-500/70">
        <div class="grid grid-cols-1 gap-0 lg:grid-cols-12">
            <div class="lg:col-span-5">
                <div class="!px-12 !py-12 card-body">
                    ...
                    <div class="text-center">
                        <h4 class="mb-2 text-blue-500 dark:text-blue-500">Bem-vindo !</h4>
                        <p class="text-slate-500 dark:text-zink-200">Realize login para continuar.</p>
                    </div>
            ...
            <div class="mx-2 mt-2 mb-2 border-none shadow-none lg:col-span-7 card bg-white/60 dark:bg-zink-500/60">
                <div class="!px-10 !pt-10 h-full !pb-0 card-body flex flex-col items-center justify-center">
                    <div class="flex items-center justify-center gap-3">
                        <img src="{{ URL::asset('build/images/auth/logo_seven.png') }}" alt=""
